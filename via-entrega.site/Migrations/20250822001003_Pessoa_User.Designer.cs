...
namespace viaentrega.site.Migrations
{
    ...
    [Migration("20250822001003_Pessoa_User")]
    partial class Pessoa_User
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("via_entrega.entities.Registrations.Usuario", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("via_entrega.entities.Registrations.Pessoa", b =>
                {
                    b.HasOne("via_entrega.entities.Registrations.Usuario", "Usuario")
                        .WithOne("Pessoa")
                        .HasForeignKey("via_entrega.entities.Registrations.Pessoa", "UsuarioId")
                        .OnDelete(DeleteBehavior.Restrict);
